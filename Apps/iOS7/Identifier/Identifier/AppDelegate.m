...
//  Identifier
//
//  Created by Klaus Rodewig on 20.07.13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSLog(@"avertisingIdentifier: %@", [theAdvertisingIdentifier UUIDString]);
    NSLog(@"advertisingTrackingEnabled: %d", theManager.advertisingTrackingEnabled);
